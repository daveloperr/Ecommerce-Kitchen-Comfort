...
<body>
    ...
    <section id="product1" class="section-p1">
        <h2>Bakeware Products</h2>
        <p>"Elevate Your Baking Experience with Our Premium Bakeware Collection"</p>
        ...
        <?php
           ...
           $sql = "SELECT * FROM products1 WHERE category_id = 2 AND isDeleted = 0;";
